...
def random_fun_picker(type):       #choose the random function based on type
    if type == int:
        rfun = randint
    elif type == float:
        rfun = uniform
...
'''
def random_piecewise_funct( param_type, fun_number, start=0, max_limit=10, fun_type="random"):
